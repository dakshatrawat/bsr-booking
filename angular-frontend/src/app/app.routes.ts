...
import { ManagehotelimagesComponent } from './admin/managehotelimages/managehotelimages.component';
...
export const routes: Routes = [
    ...
    {path: 'admin/manage-hotel-images', component: ManagehotelimagesComponent, canActivate: [GuardService], data: {requiresAdmin: true}},
